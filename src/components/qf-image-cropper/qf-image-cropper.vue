  ...
  <view class="image-cropper" :style="{ zIndex }" @wheel="cropper.mousewheel">
    ...
    >
      ...
      <view
        ...
        id="crop-border"
        class="crop-border"
        :style="cropper.borderStyles"
      ></view>
      <view
        v-if="radius > 0"
        id="crop-circle-box"
        class="crop-circle-box"
        :style="cropper.circleBoxStyles"
      >
        <view
          class="crop-circle"
          id="crop-circle"
          :style="cropper.circleStyles"
        ></view>
      </view>
      <block v-if="showGrid">
        <view
    ...
    <view
      ...
      :style="{ zIndex: initData.area.zIndex + 99 }"
    >
      <view
        v-if="(rotatable || reverseRotatable) && !!imgSrc"
        class="action-bar"
      >
        <view
          v-if="reverseRotatable"
          class="rotate-icon"
          @click="cropper.rotateImage270"
        ></view>
        <view
          v-if="rotatable"
          class="rotate-icon is-reverse"
          @click="cropper.rotateImage90"
        ></view>
      </view>
